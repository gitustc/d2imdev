...
void set_config()
{
    glb_config.mpq_file[3]   = NULL;
    glb_config.mpq_file[2]   = NULL;
    glb_config.mpq_file[1]   = NULL;
    glb_config.mpq_file[0]   = NULL;
    glb_config.mod_dir[0]    = "./res/demo/";

    glb_config.fullscreen    = "NO";
    glb_config.screen.width  = 1024;
    glb_config.screen.height = 768;
    glb_config.screen.depth  = 32;
    glb_config.screen.refresh=60;
    glb_config.scroll.keyb.x =40;
    glb_config.scroll.keyb.y  =20;
    glb_config.scroll.mouse.x =20;
    glb_config.scroll.mouse.y =10;
    glb_config.scroll.edit.x  =20;
    glb_config.scroll.edit.y  =20;
    glb_config.scroll.obj_edit=2;
    glb_config.mouse_speed.x  =2;
    glb_config.mouse_speed.y  =2;
    glb_config.gamma          =GC_130;
    glb_config.normal_type2         = "YES";
    glb_config.always_max_layers    = "YES";
    glb_config.stretch_sprites      = "YES";
    glb_config.winobj_scroll_keyb   = "YES";
    glb_config.winobj_scroll_mouse  = "NO" ;
    glb_config.center_zoom          = 1;
    glb_config.nb_type1_per_act     = 60   ;
    glb_config.nb_type2_per_act     = 150  ;
    glb_config.minimize_ds1         = "YES";
    glb_config.lower_speed_zoom_out = "NO" ;
    glb_config.workspace_enable     = "YES";
}
